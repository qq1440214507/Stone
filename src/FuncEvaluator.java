...
public class FuncEvaluator {
    ...
    @Reviser
    public static class DefStatementEx extends DefStatement {

        public DefStatementEx(List<ASTree> children) {
            super(children);
        }
    ...
    public static class ArgumentsEx extends Arguments{
        ...
        public Object eval(Environment callerEnv,Object value){
            ...
            for (ASTree asTree : this) {
                ((ParamsEx) params).eval(newEnv,num++, ((BasicEvaluator.ASTreeEx) asTree).eval(callerEnv));
            }
